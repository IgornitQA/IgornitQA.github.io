...
Персональное портфолио: опыт в QUGO, smoke- и E2E-автоматизация, кейсы расширения API-регресса и разработки Happy Path Bot. Статический сайт для GitHub Pages без сборки, внешних библиотек, аналитики и форм сбора данных.
